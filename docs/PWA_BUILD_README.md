...
- in-app readiness now gives a simple launch-readiness verdict and checkpoint score comparison
...
- [x] In-app backend/session auth diagnostics exist
...
- [x] in-app readiness verdict exists
