  ...
  const categories = [
    ...
    },
    {
      ...
      faqs: [
        ...
        { q: "Can I get a copy of your DPA?", a: <span>Yes. You can request our DPA by emailing <a href="mailto:legal.factorynerve.online@redvortexorg.me" className="text-[var(--accent)] hover:underline">legal.factorynerve.online@redvortexorg.me</a> or view it on our <Link href="/dpa" className="text-[var(--accent)] hover:underline">DPA page</Link>.</span> },
      ],
    },
    {
      title: "Data & Privacy",
      ...
      faqs: [
        ...
        { q: "How do I delete my account?", a: "Account deletion requests can be submitted through workspace settings or by contacting support.factorynerve.online@redvortexorg.me. We will process the deletion within 30 days, subject to legal retention obligations." },
    ...
    },
    {
      ...
      faqs: [
        ...
        { q: "How do I get support?", a: <span>Email <a href="mailto:support.factorynerve.online@redvortexorg.me" className="text-[var(--accent)] hover:underline">support.factorynerve.online@redvortexorg.me</a> for standard support. Enterprise customers have access to 24/7 priority support with a 2-hour response time for critical issues.</span> },
        ...
        { q: "How do I report a bug?", a: "Report bugs through the in-app feedback tool or email support.factorynerve.online@redvortexorg.me. Critical security vulnerabilities should be reported to security.factorynerve.online@redvortexorg.me." },
