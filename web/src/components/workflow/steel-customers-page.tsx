        ...
        <section className="rounded-[2rem] border border-[var(--border)] bg-[linear-gradient(135deg,rgba(20,24,36,0.96),rgba(12,18,28,0.9))] p-6 shadow-2xl backdrop-blur">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="max-w-4xl">
              <div className="text-sm uppercase tracking-prominent text-[var(--accent)]">Steel Customer Ledger</div>
                        ...
                        <tr key={customer.id} className="border-b border-[var(--border)]/60 last:border-none">
                          <td className="px-3 py-3">
                            <div className="flex flex-wrap items-center gap-2">
                              ...
                              <div className={`inline-flex rounded-full border px-2 py-0.5 text-[10px] uppercase tracking-label ${verificationBadgeClass(customer.verification_status)}`}>
                          ...
                          <td className="px-3 py-3">
                            <div className={`inline-flex rounded-full border px-3 py-1 text-xs uppercase tracking-caption ${riskBadgeClass(customer.risk_level)}`}>
                              {customer.risk_level}
                            </div>
