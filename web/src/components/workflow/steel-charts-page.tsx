  ...
  return (
    <main className="min-h-screen px-4 py-8 md:px-8">
      <div className="mx-auto max-w-7xl space-y-6">
        <section className="rounded-section border border-[var(--border)] bg-[linear-gradient(135deg,rgba(20,24,36,0.96),rgba(12,18,28,0.9))] p-6 shadow-2xl backdrop-blur">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="max-w-4xl">
              <div className="text-sm uppercase tracking-prominent text-[var(--accent)]">Steel Charts</div>
        ...
        <section className="space-y-3">
          <div className="flex flex-wrap items-end justify-between gap-3">
            <div>
              <div className="text-sm uppercase tracking-header text-[var(--accent)]">Interactive Board</div>
              <h2 className="mt-1 text-2xl font-semibold text-[var(--text)]">Read trends, filter patterns, and investigate drift</h2>
          ...
          {dashboardData ? (
            ...
            <Card>
              <CardHeader>
                <div className="text-sm text-[var(--muted)]">Chart board</div>
                <CardTitle className="text-xl text-[var(--text)]">Chart data is not available yet</CardTitle>
              </CardHeader>
