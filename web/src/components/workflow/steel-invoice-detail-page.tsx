...
function dispatchStatusBadgeClass(status: string | null | undefined) {
  ...
  if (status === "dispatched") return "border-[var(--accent-soft)] bg-[var(--accent-soft)] text-[var(--accent)]";
  if (status === "exited") return "border-[var(--accent-soft)] bg-[var(--accent-soft)] text-[var(--accent)]";
