// web/src/components/ocr/CreditNoteReviewView.tsx
"use client";
...
const HEADER_FIELDS = [
  ...
  {
    "key": "amount_details.total_amount",
    "label": "Total Amount"
  }
];
...
export function CreditNoteReviewView({
  data,
  onSave,
  onSubmit,
  onApprove,
      ...
      <Card className="border-[var(--border-strong)]">
        <CardHeader className="pb-2 cursor-pointer" onClick={() => setShowHeaderEditor(!showHeaderEditor)}>
          <div className="flex items-center justify-between">
            <CardTitle className="text-sm font-medium">Credit Note Fields</CardTitle>
