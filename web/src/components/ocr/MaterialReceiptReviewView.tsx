// web/src/components/ocr/MaterialReceiptReviewView.tsx
"use client";
...
const HEADER_FIELDS = [
  ...
  {
    "key": "vehicle_details.vehicle_number",
    "label": "Vehicle No"
  }
];
...
export function MaterialReceiptReviewView({
  data,
  onSave,
  onSubmit,
  onApprove,
      ...
      <Card className="border-[var(--border-strong)]">
        <CardHeader className="pb-2 cursor-pointer" onClick={() => setShowHeaderEditor(!showHeaderEditor)}>
          <div className="flex items-center justify-between">
            <CardTitle className="text-sm font-medium">Material Receipt Fields</CardTitle>
