// web/src/components/ocr/LedgerSheetReviewView.tsx
"use client";
...
const HEADER_FIELDS = [
  ...
  {
    "key": "account_info.opening_balance",
    "label": "Opening Balance"
  },
  {
    "key": "totals.total_debit",
    "label": "Total Debit"
  },
  {
    "key": "totals.total_credit",
    "label": "Total Credit"
  },
  {
    "key": "totals.closing_balance",
...
export function LedgerSheetReviewView({
  data,
  onSave,
  onSubmit,
  onApprove,
      ...
      <Card className="border-[var(--border-strong)]">
        <CardHeader className="pb-2 cursor-pointer" onClick={() => setShowHeaderEditor(!showHeaderEditor)}>
          <div className="flex items-center justify-between">
            <CardTitle className="text-sm font-medium">Ledger Sheet Fields</CardTitle>
