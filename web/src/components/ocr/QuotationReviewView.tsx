// web/src/components/ocr/QuotationReviewView.tsx
"use client";
...
const HEADER_FIELDS = [
  ...
  {
    "key": "pricing_summary.total_amount",
    "label": "Total Amount"
  }
];
...
export function QuotationReviewView({
  data,
  onSave,
  onSubmit,
  onApprove,
      ...
      <Card className="border-[var(--border-strong)]">
        <CardHeader className="pb-2 cursor-pointer" onClick={() => setShowHeaderEditor(!showHeaderEditor)}>
          <div className="flex items-center justify-between">
            <CardTitle className="text-sm font-medium">Vendor Quotation Fields</CardTitle>
