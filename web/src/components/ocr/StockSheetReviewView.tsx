// web/src/components/ocr/StockSheetReviewView.tsx
"use client";
...
export function StockSheetReviewView({
  data,
  onSave,
  onSubmit,
  onApprove,
      ...
      <Card className="border-[var(--border-strong)]">
        <CardHeader className="pb-2 cursor-pointer" onClick={() => setShowHeaderEditor(!showHeaderEditor)}>
          <div className="flex items-center justify-between">
            <CardTitle className="text-sm font-medium">Stock Sheet Fields</CardTitle>
