  ...
  if (!user) {
    return (
      <main className="flex min-h-screen items-center justify-center px-6 py-16">
        <Card className="w-full max-w-lg border border-[var(--border)] bg-[var(--card)] shadow-xl">
          <CardHeader>
            <CardTitle className="text-2xl">Open the workspace</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-sm text-[var(--muted)]">
              Sign in to continue to your factory operations workspace.
            </p>
  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-6 py-16">
      <Card className="w-full max-w-lg border border-[var(--border)] bg-[var(--card)] shadow-xl">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-[var(--muted)]">
            Your role-based home is ready. If the redirect takes longer than expected, use the button below.
          </p>
