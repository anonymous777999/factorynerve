      ...
      {visibleToasts.map((toast) => (
        ...
        >
          <div className="flex items-start justify-between gap-3">
            ...
            <button
              type="button"
              className="rounded-control text-xs uppercase tracking-[0.18em] text-white/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2"
