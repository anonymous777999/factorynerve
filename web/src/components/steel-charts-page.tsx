            ...
            <div className="flex flex-wrap gap-3">
              ...
              <details className="group w-full min-w-0 rounded-3xl border border-[#e7e5e4] bg-white sm:w-auto sm:min-w-[220px]">
                ...
                <div className="flex flex-wrap gap-3 border-t border-[#f5f5f4] px-4 py-4">
                  <Link href="/steel">
                    <Button variant="ghost" className="!border-[#d6d3d1] !bg-none !bg-[#f5f5f4] !text-[#111111] hover:!border-[#a8a29e] hover:!bg-none hover:!bg-[#e7e5e4]">Steel hub</Button>
                  </Link>
                  <Link href="/reports">
              ...
              {topLowConfidenceItem ? (
                <>
                  ...
                  <Link href="/steel/reconciliations">
                    <Button variant="outline" className="!border-[#111111] !bg-none !bg-[#111111] !text-white hover:!border-[#2f2f2f] hover:!bg-none hover:!bg-[#2f2f2f]">Review</Button>
                  </Link>
                </>
              ) : (
                ...
                <>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Link href={`/steel/batches/${topLossBatch.id}`}>
                      <Button variant="outline" className="!border-[#111111] !bg-none !bg-[#111111] !text-white hover:!border-[#2f2f2f] hover:!bg-none hover:!bg-[#2f2f2f]">Batch</Button>
                    </Link>
                    <Link href="/steel?tab=risk">
                      <Button variant="ghost" className="!border-[#d6d3d1] !bg-none !bg-[#f5f5f4] !text-[#111111] hover:!border-[#a8a29e] hover:!bg-none hover:!bg-[#e7e5e4]">Risk lane</Button>
                    </Link>
                  </div>
                </>
              ) : (
