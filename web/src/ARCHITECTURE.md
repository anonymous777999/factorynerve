...
| `features/dashboard` | workspaces + api + helpers + role-forked routes | `/dashboard` (role-forked: operator gets minimal route, others get dynamic-imported management workspace), `/premium/dashboard` |
