...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: "inventory", label: "Inventory", href: "/steel/inventory", icon: "profile", domain: "operations" },
  { id: "inventory-transactions", label: "Inventory Transactions", href: "/steel/inventory/transactions", icon: "profile", domain: "operations" },
  { id: "production-record", label: "Production Record", href: "/steel/production/record", icon: "profile", domain: "operations" },
  { id: "steel-batches", label: "Steel Batches", href: "/steel/batches", icon: "profile", domain: "operations" },
  ...
  { id: "ocr-history", label: "OCR History", href: "/ocr/history", icon: "profile", domain: "review" },
